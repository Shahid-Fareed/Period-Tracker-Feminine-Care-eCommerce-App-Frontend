...
const QuestionsThree = ({ navigation }) => {
  const { login } = useAuth();
      ...
      <SafeAreaView style={styles.screen}>
        <View style={styles.headerContainer}>
          <Text allowFontScaling={false} style={styles.headerTextStyle}>
            Do you have any reproductive health disorders (PCOS, endometriosis,
            etc.)?
          </Text>
        </View>
        ...
        <View style={styles.optionsContainer}>
          ...
          <TouchableOpacity
            onPress={() => seletedHandler("No")}
            style={
              seletedOuestion === "No" ? styles.optionsSeleted : styles.options
            }
          >
            <Text
              allowFontScaling={false}
          ...
          <TouchableOpacity
            onPress={() => seletedHandler("Yes, but I am cured now")}
            style={
              seletedOuestion === "Yes, but I am cured now"
                ? styles.optionsSeleted
                : styles.options
            }
          >
            ...
            >
              Yes, but I am cured now
            </Text>
          </TouchableOpacity>
          <TouchableOpacity
            onPress={() => seletedHandler("I don’t know")}
            style={
              seletedOuestion === "I don’t know"
                ? styles.optionsSeleted
                : styles.options
            }
          >
